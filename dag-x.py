...
# configmaps = [
#     k8s.V1EnvFromSource(
#         config_map_ref=k8s.V1ConfigMapEnvSource(name="test-configmap-1")
#     ),
#     k8s.V1EnvFromSource(
#         config_map_ref=k8s.V1ConfigMapEnvSource(name="test-configmap-2")
#     ),
# ]
...
DAG_ID = "example-kubernetes-operator2"
